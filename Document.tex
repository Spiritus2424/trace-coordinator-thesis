...
\include{sections/7-Article}			% Article
\include{sections/8-General_Discussion} % General Discussion        
\include{sections/9-Conclusion}         % Conclusion.
%\backmatter
\ifthenelse{\equal{\Langue}{english}}{
